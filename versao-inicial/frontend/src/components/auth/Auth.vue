<template>
  <div class="auth-content">
    <div class="auth-modal">
      <img src="@/assets/mfrancoLogo.png" width="200" alt="Logo" />
      <hr />
      ...
      <button v-if="showSignup" @click="signup">Registre-se</button>
      <button v-else @click="signin">Entrar</button>

      <a href @click.prevent="showSignup = !showSignup">
        <span v-if="showSignup">Acessar Login</span>
        <span v-else>Não possui um cadastro? Registre-se aqui!</span>
      </a>
    </div>
  </div>
</template>
